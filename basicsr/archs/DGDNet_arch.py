...
from basicsr.archs.GDFGM import GDFG
import torchvision
#########################################
...
class TransformerBlock(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, win_size=8, shift_size=0,
        ...
        self.optimize_fre = GDFG(dim = dim,size = input_resolution[0])
...
class DGDNet(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        # Output Projection
        y = self.output_proj(deconv3)#out_ch=6
        y=self.activation(y)
        # a = y[0,3:,:,:]
        return y
