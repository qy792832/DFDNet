...
from basicsr.losses.LDG_loss import LGDLoss
from basicsr.losses.fft_loss import get_Fre
from basicsr.losses.clip_loss import L_clip_MSE
...
class DeflareModel(SRModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        self.out_put = self.net_g(self.lq)
        ...
        loss_lgd = self.l_cut.get_attn_cut_loss(self.gt,self.deflare)
        l_total +=loss_lgd
        loss_dict['l_lgd']=loss_lgd


        loss_clip = (self.l_clip(self.deflare,self.gt))
        l_total +=loss_clip
